...
| [compprov-plugin-example](https://github.com/compprov/compprov-plugin-example) | [![GitHub release](https://img.shields.io/github/v/release/compprov/compprov-plugin-example?color=brightgreen)](https://github.com/compprov/compprov-plugin-example/releases) | An example plugin for compprov-analytics, showing how to extend it without modifying its code |
